...
export function add_legend_cs_major(legend) {
  // Handmade legend
  var lx = 50 // 350, 70
  var ly = 330 // 480, 330
  var legend_width = 130;
  ...
  legend.append("text").attr("x", lx+20).attr("y", ly+120).text("Recommended").style("font-size", "12px").attr("alignment-baseline","middle")
  legend.append("text").attr("x", lx-25).attr("y", ly+160).text("Note: This graph only represents courses that are offered by the Computer Science department.").style("font-size", "12px").attr("alignment-baseline","middle")
  legend.append("text").attr("x", lx+5).attr("y", ly+175).text("Additionally, only the courses commonly taken by students in CS specializations are included.").style("font-size", "12px").attr("alignment-baseline","middle")
  legend.append("text").attr("x", lx+5).attr("y", ly+190).text("Course pre-requisites from outside the CS department are not included here.").style("font-size", "12px").attr("alignment-baseline","middle")
